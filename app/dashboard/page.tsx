...
import { BookOpen, Video, Users, Calendar, Award, MessageCircle, Target } from 'lucide-react'
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 border-amber-200 bg-amber-50">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <CardTitle className="text-lg">Cadskills NPC</CardTitle>
                    <CardDescription>CAD training with Coach Maximus</CardDescription>
                  </div>
                </div>
              </CardHeader>
            </Card>
